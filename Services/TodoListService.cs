...
namespace TodoListClient.Service

{
...

    {
...

        {
            ...
            var response = await this._httpClient.PostAsync($"{_TodoListBaseAddress}/api/TodoItems", jsoncontent);
...

        {
            ...
            var response = await _httpClient.DeleteAsync($"{_TodoListBaseAddress}/api/TodoItems/{id}");
...

        {
            ...
            var response = await _httpClient.PutAsync($"{_TodoListBaseAddress}/api/TodoItems/{todo.Id}", jsoncontent);
...

        {
            ...
            var response = await _httpClient.GetAsync($"{_TodoListBaseAddress}/api/TodoItems");
...

        {
            ...
            var response = await _httpClient.GetAsync($"{_TodoListBaseAddress}/api/TodoItems/{id}");
